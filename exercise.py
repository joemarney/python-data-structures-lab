...
foods = ('pasta', 'rice', 'pizza',)

def combine_foods(tuple):
    # your code here
    meal = ''
    for food in tuple:
        meal = meal + ' ' + food
...
# Unsure if it this a personal thing but that question is not as clear as it could be
...
def hometown_info(dict):
    # your code here
    home_town_message = f'I was born in {dict['city']}, {dict['state']} - population of {dict['population']}'
